...
export default function FindPeople() {
  ...
  //Pg 176, the FindPeople component, to display the who to follow feature
  useEffect(() => {
  ...
  // Pg 176, Fetched list of users iterated over and rendered by Material-UI
    return (<div>
