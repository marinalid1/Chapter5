...
export default function Profile({ match }) {
  ...
  useEffect(() => {
    ...
    read({
      ...
      if (data && data.error) {
        ...
        // Pg 171, updating the Profile component
  ...
  // Pg 171, updating the Profile component, check follow
  ...
  // Pg 171, updating the Profile component, click follow button
  ...
  // Pg 163, Showing a photo in a view
